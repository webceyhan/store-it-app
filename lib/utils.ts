...
import * as config from "./appwrite/config";
...
export const constructFileUrl = (bucketFileId: string) => {
  return `${config.ENDPOINT}/storage/buckets/${config.BUCKET_ID}/files/${bucketFileId}/view?project=${config.PROJECT_ID}`;
};

export const constructDownloadUrl = (bucketFileId: string) => {
  return `${config.ENDPOINT}/storage/buckets/${config.BUCKET_ID}/files/${bucketFileId}/download?project=${config.PROJECT_ID}`;
};
